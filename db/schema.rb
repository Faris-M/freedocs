...
ActiveRecord::Schema.define(version: 2020_02_06_145648) do
  ...
  create_table "join_table_specialties", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["doctor_id"], name: "index_join_table_specialties_on_doctor_id"
    t.index ["specialty_id"], name: "index_join_table_specialties_on_specialty_id"
  end
